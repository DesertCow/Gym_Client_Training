  ...
  return (
    ...
    <div>
      ...
      <div className="d-flex flex-row">
        ...
        <div className="w-100 d-flex row justify-content-center mx-0">
          <h1 className="row justify-content-center editProfileUserName text-center mt-3">Clayton Skaggs</h1>
          <h3 className="row justify-content-center editProfileText text-center mt-2 mb-3"> Welcome to your Alpine Athletics Profile</h3>
